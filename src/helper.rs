...
pub fn connect_to_db() -> my::Pool {
    ...
    pool.prep_exec(r"USE IMAPServer_rs; CREATE TABLE IF NOT EXISTS Users (id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(30) NOT NULL, passwd VARCHAR(300) NOT NULL) CHARSET=utf8;", ()).unwrap();
    pool
}
